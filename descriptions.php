...
<html>
	<head>
		...
		<title>Descriptions - Cost Sheet System</title>
	...
	<body class="fixed-left" ng-app="description" ng-controller="descriptionCtrl" account-profile>
		...
		<script src="modules/description.js"></script>

		<!-- controller -->
		<script src="controllers/description.js"></script>
